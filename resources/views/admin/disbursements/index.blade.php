...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($totalPending, 0, ',', '.') }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($totalApproved, 0, ',', '.') }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($totalRejected, 0, ',', '.') }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mt-1">Rp {{ number_format($totalAmountApproved, 0, ',', '.') }}</h3>
                </div>
    ...
    <!-- Filter Section -->
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="GET" action="{{ route('admin.disbursements.index') }}" class="flex gap-4">
            <div class="flex-1">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500">{{ $disbursement->campaign->user->email }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900">{{ Str::limit($disbursement->campaign->title, 30) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-600">No withdrawal requests found</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
